...
<head>
    ...
    <title>Ready To Eat Products – ATMABISWAS (আত্মবিশ্বাস) Bangladesh</title>
    <?php include 'seo.php'; ?>
...
<body>
    ...
    <div class="container">
        ...
        <section class="section">
            <h2>A Glimpse of ATMABISWAS RMTP Project</h2>
        ...
        <section class="section">
            <h2>Building Connections, Creating Opportunities</h2>
