...
<head>
    ...
    <title>Enterprise Development – ATMABISWAS (আত্মবিশ্বাস) Bangladesh</title>
    <?php include 'seo.php'; ?>
...
<body>
    ...
    <section class="page-hero">
        <div class="page-hero-inner">
            ...
            <p>ATMABISWAS drives sustainable growth by equipping small businesses with digital tools, strategic guidance,
                and financial support for long-term success.</p>
        </div>
    </section>
        ...
        <div class="card">
            ...
            <div class="services">
                <div class="service-card">
                    <img src="enterprise_development/enterprice_pic1.jpg" loading="lazy" alt="Micro Finance">
                    <h3>Short-Term Loan (Weekly Repayment)</h3>
                    <p>
                ...
                <div class="service-card">
                    <img src="enterprise_development/enterprice_pic2.jpg" loading="lazy" alt="Training Camp">
                    <h3>Medium-Term Loan (Monthly Repayment)</h3>
                    <p>
                ...
                <div class="service-card">
                    <img src="enterprise_development/enterprice_pic5.jpg" loading="lazy" alt="Long-term Loans">
                    <h3>Long-Term Loan (6-Month Repayment)</h3>
                    <p>
